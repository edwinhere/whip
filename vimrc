...
if filereadable(expand("~/vimfiles/_vimrc.local.bundles"))
  source ~/vimfiles/_vimrc.local.bundles
endif
...
if filereadable(expand("~/vimfiles/_vimrc.local"))
